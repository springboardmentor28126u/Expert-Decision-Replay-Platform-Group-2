        ...
        paginated.forEach(d => {
            ...
            tbody.innerHTML += `
                <tr>
                    ...
                    <td class="text-dark">${d.category_id === 1 ? 'Finance' : (d.category_id === 2 ? 'Technology' : 'Operations')}</td>
                    <td>
                        <div class="d-flex align-items-center gap-2">
                            <div class="avatar-sm bg-light text-primary rounded-circle d-flex align-items-center justify-content-center" style="width:24px;height:24px;font-size:10px;font-weight:bold;">JD</div>
                            <span class="text-dark small fw-medium">John Doe</span>
                        </div>
                    </td>
