...
/**
 * ManagerDashboard - Manager role dashboard page content.
 *
 * Props:
 ...
 *
 * Fetches GET /dashboard/manager via the Dashboard API service and renders:
 *   - Loading spinner while the initial request is in flight
 *   - Error panel with retry if the API call fails
 *   - 6 responsive StatCards (Total Decisions / Draft / Under Review / Approved / Rejected / Archived)
 *   - RecentDecisionTable with the recent decisions list
 */
export default function ManagerDashboard({ token, onSelectDecision = null }) {
